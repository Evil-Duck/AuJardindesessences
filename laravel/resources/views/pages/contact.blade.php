...
if(isset($_GET)){
	if(isset($_GET['nom'])&&isset($_GET['prenom'])&&isset($_GET['mail'])&&isset($_GET['subject'])&&isset($_GET['msg']) && isset($_GET['submit'])){
		...
		$Mailcontact = "Jardindesessences@gmail.com";
		$mails = $_GET['mail'];
		...
		<div class="panel grid-80 suffix-10 prefix-10">
	      ...
	      <div id="Cmaps" class="panel-content" Onclick="IframeClick('maps')">
	        ...
	        <ul class="info-list fa-ul">
		    	<li><i class="fa-li fa fa-dot-circle-o"></i>Téléphone : +41 / 76 384 16 64</li>
		    	<li><i class="fa-li fa fa-dot-circle-o"></i>E-Mail: Jardindesessences@gmail.com</li>
	    ...
	    <div class="panel grid-80 suffix-10 prefix-10">
	      <div class="panel-content">
	        <form action="/contact" method="get" accept-charset="utf-8">
		        <input type="text" name="nom" value="<?php if(isset($nom)){echo $nom;} ?>" placeholder="Votre nom ..." class="input-50" /required>
		        <input type="text" name="prenom" value="<?php if(isset($prenom)){echo $prenom;} ?>" placeholder="Votre prenom ..." class="input-50" /required>
		        <input type="email" name="mail" value="<?php if(isset($mails)){echo $mails;} ?>" placeholder="Votre adresse e-mail ..."/required>
		        <input type="text" name="subject" value="<?php if(isset($sujet)){echo $sujet;} ?>" placeholder="Le sujet de votre demande ..."/required>
		        <textarea name="msg" placeholder="Contenu du message ..." /required><?php if(isset($msgU)){echo $msgU;} ?></textarea>
